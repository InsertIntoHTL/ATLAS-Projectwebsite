...
!function () {
    "use strict";
    var t = function (t) {
        var e = document.getElementById(t.mainElement), s = e.getElementsByTagName("section"), n = {
            container: e,
            sections: s,
    ...
    t.prototype.init = function () {
        ...
        return this.mouseWheelAndKey = function (t) {
            t.deltaY > 0 || 40 == t.keyCode ? (s.removeEvents(), s.defaults.currentPosition++, s.changeCurrentPosition(s.defaults.currentPosition)) : (t.deltaY < 0 || 38 == t.keyCode) && (s.removeEvents(), s.defaults.currentPosition--, s.changeCurrentPosition(s.defaults.currentPosition))
            ...
            var t = this.defaults.animateTime, e = this.defaults.animateFunction,
